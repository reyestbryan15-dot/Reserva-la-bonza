export const translations = {
  ...
  es: {
    ...
    about: {
      ...
      who_we_are_label: "Quiénes Somos",
      who_we_are_title: "Tu puerta de entrada a experiencias inolvidables",
      who_we_are_p1: "Somos una agencia Operadora dedicada a promover el Turismo principalmente en la ciudad de Santa Marta Colombia, ofrecemos asesoría y conectamos al turista con las diversas opciones de hospedaje y atracciones que ofrece esta hermosa región, concentrando nuestros esfuerzos en generar turismo sostenible",
      who_we_are_p2: "Gestionamos de forma ágil, responsable y segura sus reservaciones, ofreciendo siempre la mejor opción disponible, adaptada a sus requerimientos y preferencias, contamos con un equipo de asesoría profesional dispuesto siempre a brindar el soporte necesario para organizar su viaje y hacer de este una experiencia inolvidable, ya que somos conscientes que un cliente satisfecho es la mejor carta de recomendación.",
      ...
      vision_text: "Ser la plataforma líder en el sector turístico e inmobiliario, reconocida por nuestra innovación y confianza.",
      wtc_title: "World Trade Center Barranquilla —",
      wtc_office: "Oficina de Representación Reserva La Bonanza Santa Marta",
      wtc_quote: "Como oficina oficial de WTC Barranquilla en Santa Marta, en Reserva La Bonanza fusionamos el turismo de excelencia con la red de negocios más potente del mundo. Nuestra misión es proyectar el potencial de nuestra región hacia una expansión nacional y mundial...",
      wtc_btn: "Ver Certificación Legal",
      wtc_modal_title: "Documento de Respaldo Oficial WTC",
      wtc_modal_footer: "Este documento certifica a Reserva La Bonanza S.A.S como oficina de apoyo autorizada en Santa Marta.",
      wtc_hover_label: "Ver Aval",
      legal_label: "LEGALIDAD",
      legal_title: "LEGALIDAD",
      legal_full_description: "Reservas La Bonanza SAS, es una agencia operadora turística identificada con el NIT 901593475-7, registrada bajo el RNT 114606 del Ministerio de Desarrollo de Industria y Comercio, matriculada en la Cámara de Comercio de Santa Marta bajo el Nro. 254869, cumplimos con todos los requisitos de Ley, con ámbito de operación Nacional e Internacional."
    }
  },
  ...
  en: {
    ...
    about: {
      ...
      description: "At Reservas Turismo, we are dedicated to connecting travelers with the best accommodations and real estate opportunities. With years of market experience, we guarantee security, comfort, and personalized service.",
      who_we_are_label: "Who We Are",
      who_we_are_title: "Your gateway to unforgettable experiences",
      who_we_are_p1: "We are an Operating agency dedicated to promoting Tourism primarily in the city of Santa Marta, Colombia. We offer consulting and connect tourists with various lodging options and attractions that this beautiful region offers, focusing our efforts on generating sustainable tourism.",
      who_we_are_p2: "We manage your reservations in an agile, responsible, and secure manner, always offering the best available option adapted to your requirements and preferences. We have a professional consulting team always ready to provide the necessary support to organize your trip and make it an unforgettable experience, as we are aware that a satisfied customer is the best letter of recommendation.",
      mission_title: "Our Mission",
      mission_text: "To transform the way people travel and find their ideal home, offering transparency and quality in every reservation.",
      vision_title: "Our Vision",
      vision_text: "To be the leading platform in the tourism and real estate sector, recognized for our innovation and trust.",
      wtc_title: "World Trade Center Barranquilla —",
      wtc_office: "Reserva La Bonanza Santa Marta Representative Office",
      wtc_quote: "As the official office of WTC Barranquilla in Santa Marta, at Reserva La Bonanza we merge tourism excellence with the world's most powerful business network. Our mission is to project our region's potential towards national and global expansion...",
      wtc_btn: "View Legal Certification",
      wtc_modal_title: "Official WTC Support Document",
      wtc_modal_footer: "This document certifies Reserva La Bonanza S.A.S as an authorized support office in Santa Marta.",
      wtc_hover_label: "View Guarantee",
      legal_label: "LEGALITY",
      legal_title: "LEGALITY",
      legal_full_description: "Reservas La Bonanza SAS is a tourism operator agency identified with NIT 901593475-7, registered under RNT 114606 with the Ministry of Industry and Trade Development, registered with the Santa Marta Chamber of Commerce under No. 254869. We comply with all legal requirements, with a national and international scope of operation."
    }
  },
  ...
  fr: {
    ...
    about: {
      ...
      who_we_are_label: "Qui Sommes-Nous",
      who_we_are_title: "Votre porte d'entrée vers des expériences inoubliables",
      who_we_are_p1: "Nous sommes une agence opératrice dédiée à la promotion du tourisme principalement dans la ville de Santa Marta, Colombie. Nous offrons des conseils et connectons les touristes aux diverses options d'hébergement et attractions de cette belle région, en concentrant nos efforts sur le tourisme durable.",
      who_we_are_p2: "Nous gérons vos réservations de manière agile, responsable et sécurisée, en offrant toujours la meilleure option disponible, adaptée à vos besoins et préférences. Nous disposons d'une équipe de conseillers professionnels toujours prêts à fournir le soutien nécessaire pour organiser votre voyage et en faire une expérience inoubliable, car nous sommes conscients qu'un client satisfait est la meilleure recommandation.",
      ...
      vision_text: "Être la plateforme leader du secteur touristique et immobilier, reconnue pour son innovation et sa confiance.",
      wtc_title: "World Trade Center Barranquilla —",
      wtc_office: "Bureau de Représentation Reserva La Bonanza Santa Marta",
      wtc_quote: "En tant que bureau officiel du WTC Barranquilla à Santa Marta, chez Reserva La Bonanza, nous fusionnons l'excellence touristique avec le réseau d'affaires le plus puissant au monde. Notre mission est de projeter le potentiel de notre région vers une expansion nationale et mondiale...",
      wtc_btn: "Voir la Certification Légale",
      wtc_modal_title: "Document de Soutien Officiel WTC",
      wtc_modal_footer: "Ce document certifie Reserva La Bonanza S.A.S en tant que bureau de soutien autorisé à Santa Marta.",
      wtc_hover_label: "Voir l'Aval",
      legal_label: "LÉGALITÉ",
      legal_title: "LÉGALITÉ",
      legal_full_description: "Reservas La Bonanza SAS est une agence opératrice touristique identifiée par le NIT 901593475-7, enregistrée sous le RNT 114606 auprès du Ministère du Développement de l'Industrie et du Commerce, immatriculée à la Chambre de Commerce de Santa Marta sous le n° 254869. Nous respectons toutes les exigences légales, avec un champ d'action national et international."
    }
  },
  ...
  de: {
    ...
    about: {
      ...
      description: "Bei Reservas Turismo widmen wir uns der Verbindung von Reisenden mit den besten Unterkünften und Immobilienmöglichkeiten. Mit jahrelanger Markterfahrung garantieren wir Sicherheit, Komfort und persönlichen Service.",
      who_we_are_label: "Wer wir sind",
      who_we_are_title: "Ihr Tor zu unvergesslichen Erlebnissen",
      who_we_are_p1: "Wir sind eine Reiseagentur, die sich der Förderung des Tourismus vor allem in der Stadt Santa Marta, Kolumbien, widmet. Wir bieten Beratung an und verbinden Touristen mit den verschiedenen Unterkunftsmöglichkeiten und Attraktionen dieser wunderschönen Region, wobei wir uns auf nachhaltigen Tourismus konzentrieren.",
      who_we_are_p2: "Wir verwalten Ihre Reservierungen schnell, verantwortungsbewusst und sicher und bieten immer die beste verfügbare Option an, die auf Ihre Anforderungen und Wünsche zugeschnitten ist. Wir verfügen über ein professionelles Beratungsteam, das Ihnen jederzeit die nötige Unterstützung bei der Organisation Ihrer Reise bietet, da wir wissen, dass ein zufriedener Kunde die beste Empfehlung ist.",
      mission_title: "Unsere Mission",
      mission_text: "Die Art und Weise, wie Menschen reisen und ihr ideales Zuhause finden, zu transformieren, indem wir Transparenz und Qualität bei jeder Buchung bieten.",
      vision_title: "Unsere Vision",
      vision_text: "Die führende Plattform im Tourismus- und Immobiliensektor zu sein, die für Innovation und Vertrauen bekannt ist.",
      wtc_title: "World Trade Center Barranquilla —",
      wtc_office: "Repräsentanz Reserva La Bonanza Santa Marta",
      wtc_quote: "Als offizielles Büro des WTC Barranquilla in Santa Marta verbinden wir bei Reserva La Bonanza exzellenten Tourismus mit dem weltweit stärksten Geschäftsnetzwerk. Unsere Mission ist es, das Potenzial unserer Region auf eine nationale und globale Expansion auszuweiten...",
      wtc_btn: "Rechtliche Zertifizierung ansehen",
      wtc_modal_title: "Offizielles WTC-Unterstützungsdokument",
      wtc_modal_footer: "Dieses Dokument zertifiziert Reserva La Bonanza S.A.S als autorisiertes Unterstützungsbüro in Santa Marta.",
      wtc_hover_label: "Garantie ansehen",
      legal_label: "RECHTMÄSSIGKEIT",
      legal_title: "RECHTMÄSSIGKEIT",
      legal_full_description: "Reservas La Bonanza SAS ist ein Reiseveranstalter mit der Steuernummer (NIT) 901593475-7, registriert unter der RNT 114606 beim Ministerium für Industrie- und Handelsentwicklung, eingetragen bei der Handelskammer von Santa Marta unter der Nummer 254869. Wir erfüllen alle gesetzlichen Anforderungen mit nationalem und internationalem Tätigkeitsbereich."
    }
  },
  ...
  zh: {
    ...
    about: {
      title: "关于我们",
      subtitle: "开启您难忘体验的大门",
      description: "在 Reservas Turismo，我们致力于为旅客连接最佳住宿和房地产机会。凭借多年的市场经验，我们保证安全、舒适和个性化服务。",
      who_we_are_label: "关于我们",
      who_we_are_title: "开启您难忘体验的大门",
      who_we_are_p1: "我们是一家致力于在哥伦比亚圣玛尔塔市推广旅游业的运营机构。我们提供咨询服务，并将游客与该美丽地区提供的各种住宿和景点联系起来，致力于打造可持续旅游。",
      who_we_are_p2: "我们以敏捷、负责和安全的方式管理您的预订，始终提供最适合您需求和喜好的最佳选择。我们拥有一支专业的咨询团队，随时准备为您提供必要的支持，组织您的旅行，让其成为一段难忘的经历，因为我们深知，满意的客户就是最好的推荐信。",
      mission_title: "我们的使命",
      mission_text: "改变人们旅行和寻找理想家园的方式，在每次预订中提供透明度和品质。",
      vision_title: "我们的愿景",
      vision_text: "成为旅游和房地产领域的领先平台，以创新和信任著称。",
      wtc_title: "巴兰基亚世界贸易中心 —",
      wtc_office: "圣玛尔塔 Reserva La Bonanza 代表处",
      wtc_quote: "作为巴兰基亚 WTC 在圣玛尔塔的官方办公室，我们在 Reserva La Bonanza 将卓越的旅游业与全球最强大的商业网络相结合。我们的使命是将我们地区的潜力推向全国乃至全球的扩张...",
      wtc_btn: "查看法律认证",
      wtc_modal_title: "WTC 官方支持文件",
      wtc_modal_footer: "本文件证明 Reserva La Bonanza S.A.S 为圣玛尔塔授权的支持办公室。",
      wtc_hover_label: "查看认证",
      legal_label: "法律合规",
      legal_title: "法律合规",
      legal_full_description: "Reservas La Bonanza SAS 是一家旅游经营机构，纳税人识别号 (NIT) 为 901593475-7，在工商旅游部注册的国家旅游登记号 (RNT) 为 114606，并在圣玛尔塔商会注册，注册号为 254869。我们遵守所有法律要求，业务范围涵盖国内及国际市场。"
    },
    booking: {
